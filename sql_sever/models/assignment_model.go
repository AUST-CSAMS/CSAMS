...
type Assignment struct {
	...
	Figure4                     string                      `gorm:"size:256" json:"figure_6"`
	Figure7                     string                      `gorm:"size:256" json:"figure_5"`
	Figure5                     string                      `gorm:"size:256" json:"figure_4"`
	Figure6                     string                      `gorm:"size:256" json:"figure_7"`
