...
type ActivityModel struct {
	AssignmentModel     AssignmentModel `gorm:"foreignKey:AssignmentID;associationForeignKey:AssignmentID"`
	UserID              uint
	UserModel           UserModel `gorm:"foreignKey:UserID;AssociationForeignKey:ID"`
